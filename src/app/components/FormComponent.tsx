  ...
  return (
    <div className="relative min-h-screen bg-no-repeat bg-cover bg-fixed bg-center">
      ...
      <form className="" onSubmit={handleSubmit(onSubmit)}>
        ...
        <div className="w-3/4 max-w-5xl mx-auto bg-white rounded-lg shadow-lg p-10 mt-10">
          {" "}
          {/* Tarjeta para los campos del formulario */}
          <Tabs
            aria-label="Tabs with underline"
            style="underline"
            className="max-w-sm  md:max-w-xl xl:max-w-5xl mx-auto  "
          >
            <Tabs.Item title="Empresa" active={true} className="block">
              {/* titulo de formulario */}
              <div className="grid gap-2 mb-6 md:grid-cols-2 xl:grid-cols-2 ">
                <div>
        ...
        <div className="w-3/4 max-w-5xl mx-auto bg-white rounded-lg shadow-lg px-10 mt-5">
          {" "}
          {/* Tarjeta para los campos del formulario */}
          <Tabs
            aria-label="Tabs with underline"
        ...
        <Button className="mx-auto mt-10  text-white bg-blue-500 hover:bg-blue-700 font-bold py-2 px-4 rounded-md text-center" type="submit">
          <p
